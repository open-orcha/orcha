...
def test_migration_042_exists_and_is_next_sequential():
    ...
    # the host-side roster analysis storage seam (docs/orcha-cloud-local-run.md); 049 pins Code
    # Space file reads to immutable run snapshots. Keep this pin moving with the chain tip so
