...
from portal_backend.task_creation_routes import create_task
from portal_backend.task_message_routes import get_task_messages, post_message
from portal_backend.attachment_routes import (
    configure_compatibility as _configure_attachment_route_compatibility,
    serve_attachment,
...
_configure_attachment_route_compatibility(lambda: MAX_ATTACHMENT_BYTES)
...
from portal_backend.task_completion_support import (
    ...
    configure_compatibility as _configure_task_completion_compatibility,
)

_configure_task_completion_compatibility(lambda: _digest_curate)


from portal_backend.task_done_routes import (
    configure_compatibility as _configure_task_done_compatibility,
    mark_done,
)
from portal_backend.task_assignment_routes import assign_task

_configure_task_done_compatibility(
...
from portal_backend.task_dispatch_routes import (
    _deps_unmet,
    set_task_readiness,
    unassign_task,
)
from portal_backend.task_protocol_routes import update_task_protocol
from portal_backend.task_verification_routes import (
    configure_compatibility as _configure_task_verification_compatibility,
    verify_task,
)

_configure_task_verification_compatibility(lambda: _complete_and_unblock)


from portal_backend.task_cancellation_routes import cancel_task
from portal_backend.task_impact_routes import close_implications
...
from portal_backend.request_creation_routes import create_request
from portal_backend.request_lookup import require_request as _require_request
from portal_backend.request_response_routes import get_request, respond_request
...
# Decision `reason`: optional on approve, required on reject; kept here as a
# compatibility reminder for portal contract tests and facade readers.


from portal_backend.request_close_routes import close_request
from portal_backend.request_nudge_routes import (
    _task_request_context_block,
    nudge_request,
)
from portal_backend.request_resolution_routes import (
    escalate_request,
    triage_close_request,
)


from portal_backend.request_acceptance_routes import (
    accept_task_request,
    configure_compatibility as _configure_request_acceptance_compatibility,
)
from portal_backend.request_rejection_routes import reject_task_request, suggest_agent
from portal_backend.agent_suggestion_routes import decide_suggestion
from portal_backend.request_conversion_routes import convert_to_task

_configure_request_acceptance_compatibility(lambda: _attribute_token_run_to_task)
